...
<div class="container main-section" id="post-container">
    ...
    <div class="card position-relative mb-5" style=" background-color: #1d1d1d; color: white; border: 1px solid #363636">
        <!-- Banner -->
        <img src="{{ asset('images/society/1745057402.jpg') }}" class="card-img-top" alt="Banner" style="height: 100px; object-fit: cover;">
    
        <!-- Profile picture -->
        <img src="{{ asset('images/society/1745057402.jpg') }}" class="rounded-circle position-absolute top-50 start-0 translate-middle-y ms-3 border border-3 border-dark" style="width: 64px; height: 64px; object-fit: cover;" alt="Profile">
