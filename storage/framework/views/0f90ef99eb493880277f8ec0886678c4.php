...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container main-section">
        ...
        <p class="sub-term">
            ...
            where appropriate to ensure safety. Learn more in our <a href="<?php echo e(route('privacy')); ?>"
                class="text-white-600 underline">Privacy Policy</a>.
        </p>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PuConnect\InstituteConnect\resources\views/footer/terms.blade.php ENDPATH**/ ?>