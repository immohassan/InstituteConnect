...
<?php
    $posts = $posts->filter(function($post) use ($user) {
        return $post->user_id === $user->id && $post->society_id == "";
    });
?>
        ...
        <div class="d-flex align-items-top">
            ...
            <div class="edit-profile-btn d-flex align-content-center justify-content-between">
                <?php if(Auth::user()->id == $user->id): ?>
                    ...
                    <a href="<?php echo e(route('user.delete', ['id' => $user->id])); ?>" class="btn btn-outline-danger px-4" style="text-decoration: none; border: 2px solid;">
                        Delete Profile
                    </a>
                <?php else: ?>
                    <button id="" 
