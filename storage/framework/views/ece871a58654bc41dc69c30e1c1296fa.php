...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/footer-pages.css')); ?>">
<?php $__env->stopPush(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container main-section">
        ...
        <p class="sub-term">
            You have the right to access, correct, or delete your personal information. You may also contact us for any data-related concerns at <a href="<?php echo e(route('contact')); ?>" class="text-blue-600 underline">Contact Us</a>.
        </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PuConnect\InstituteConnect\resources\views/footer/privacy.blade.php ENDPATH**/ ?>