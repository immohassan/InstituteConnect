                ...
                <?php if($society): ?>
                    <div class="alert alert-info mb-4">
                        <div class="d-flex align-items-center">
                            <?php if($society->logo): ?>
                                <img src="<?php echo e(Storage::url($society->logo)); ?>" alt="<?php echo e($society->name); ?>"
                    ...
                    <?php if(auth()->user()->societies->count() > 0): ?>
                        <div class="list-group">
                            <?php $__currentLoopData = auth()->user()->societies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $society): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('posts.index', ['society_id' => $society->id])); ?>"
                ...
                <div class="card-body">
                    ...
                    <?php if($announcements->count() > 0): ?>
                        <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('components.announcement-card', [
                        ...
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('announcements.index')); ?>" class="btn btn-sm btn-outline-primary">View All
                                Announcements</a>
                        </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PuConnect\InstituteConnect\resources\views/posts/index.blade.php ENDPATH**/ ?>