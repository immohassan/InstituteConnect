                            ...
                            <div class="col-md-4 text-center mb-4">
                                <div class="mb-3">
                                    <?php if($user->profile_picture): ?>
                                        <img src="<?php echo e(asset('images/profile/' . $user->profile_picture)); ?>" class="rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;" alt="<?php echo e($user->name); ?>'s profile">
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <label for="department" class="form-label"><?php echo e(__('Department')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="department" value="<?php echo e(old('department', $user->department)); ?>" autocomplete="department">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="year" type="number" min="1" max="5" class="form-control <?php $__errorArgs = ['year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="year" value="<?php echo e(old('year', $user->year)); ?>" autocomplete="year">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="semester" class="form-label"><?php echo e(__('Semester')); ?></label>
                                            <input id="semester" type="number" min="1" max="8" class="form-control <?php $__errorArgs = ['semester'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="semester" value="<?php echo e(old('semester', $user->semester)); ?>" autocomplete="semester">
...
unset($__errorArgs, $__bag); ?>" name="bio" rows="3" autocomplete="bio"><?php echo e(old('bio', $user->bio)); ?></textarea>
                                    <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\New folder\InstituteConnect\resources\views/profile/edit.blade.php ENDPATH**/ ?>