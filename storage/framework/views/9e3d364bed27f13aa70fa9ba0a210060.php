        ...
        ?>
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('users_post.create')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="society_id" id="society_id" value="<?php echo e($society_id); ?>">
...
<?php /**PATH A:\New folder\InstituteConnect\resources\views/posts/create.blade.php ENDPATH**/ ?>